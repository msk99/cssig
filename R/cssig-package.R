...
#' @import data.table
#' @importFrom stats qnorm pnorm quantile p.adjust cor complete.cases setNames isoreg approx sd median
#' @importFrom utils head tail globalVariables packageVersion
#' @importFrom graphics text
#' @importFrom ggplot2 ggplot aes geom_point geom_line geom_hline geom_vline geom_rect geom_segment
#' @importFrom ggplot2 geom_text geom_density geom_histogram geom_tile geom_abline
#' @importFrom ggplot2 scale_x_continuous scale_y_continuous scale_colour_manual scale_fill_manual
#' @importFrom ggplot2 scale_fill_gradient2 labs facet_wrap facet_grid theme theme_minimal
#' @importFrom ggplot2 element_blank element_text element_line element_rect
#' @importFrom ggplot2 expansion coord_cartesian guides guide_legend margin unit waiver
NULL
